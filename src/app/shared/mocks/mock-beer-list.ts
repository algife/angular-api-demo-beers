...
export const MOCK_BEER_LIST: Beer[] = [
  {
    id: 1,
    name: 'MOCKup Buzz',
...
Drop a little Cascade in at the end of the boil to lift the profile with a bit of citrus.`,
  ...
  },
  {
    ...
    description: `A titillating, neurotic, peroxide punk of a Pale Ale. Combining attitude, style, substance, and a
little bit of low self esteem for good measure; what would your mother say? The seductive lure of the sassy passion fruit hop proves too much to resist. All that is even before we get onto the fact that there are no additives, preservatives, pasteurization or strings attached. All wrapped up with the customary BrewDog bite and imaginative twist.`,
  ...
  },
  {
    ...
    description: `Dark and powerful Islay magic infuses this tropical sensation of an IPA. Using the original Punk IPA as a base,
we boosted the ABV to 8% giving it some extra backbone to stand up to the peated smoke imported directly from Islay.`,
    ...
    brewers_tips: `After primary fermentation is complete, rack off into a secondary fermeter and add the oak
chips to replicate the authentic Islay barrel experience.`,
    contributed_by: 'Sam Mason <samjbmason>'
  },
  {
    id: 24,
    ...
    description: `The End of History: The name derives from the famous work of philosopher Francis Fukuyama, this is to beer what democracy is to
history. Complexity defined. Floral, grapefruit, caramel and cloves are intensified by boozy heat.`,
...
export const MOCK_BEER_LIST_RANDOM: Beer[] = [
  {
    id: 15,
    name: 'MOCKup Mixtape 8',
    tagline: 'An Epic Fusion Of Old Belgian, American New Wave, And Scotch Whisky.',
    first_brewed: '01/2012',
    // tslint:disable-next-line:max-line-length
    description: `This recipe is for the Belgian Tripel base. A blend of two huge oak aged beers – half a hopped up Belgian Tripel, and half a Triple India Pale Ale. Both aged in single grain whisky barrels for two years and blended, each beer brings its own character to the mix. The Belgian Tripel comes loaded with complex spicy, fruity esters, and punchy citrus hop character.`,
